...
Each facility has a Google Sheet as the source of truth for run data.

Reference docs live here:
```
/Users/m/.openclaw/workspace/shared/facilities/
  facility-01/
    google-sheet-link.md ← link to Google Sheet
    contacts.md ← department leads
    info.md ← facility details
```
