...
def normalize_search(data: Any) -> List[Dict[str, Any]]:
    if isinstance(data, list):
        ...
        items = pick_first(data, ["timeline", "tweets", "items", "list", "statuses", "result", "data"], [])
    ...
    for item in items:
        ...
        normalized.append({
            ...
            "author": pick_first(user, ["name", "screen_name", "username"], pick_first(item, ["author", "screen_name", "username"])),
...
def build_parser() -> argparse.ArgumentParser:
    ...
    detail_parser.add_argument("--json", action="store_true", dest="output_json", help="以 JSON 格式输出原始响应")
    ...
    search_parser.add_argument("--json", action="store_true", dest="output_json", help="以 JSON 格式输出原始响应")
